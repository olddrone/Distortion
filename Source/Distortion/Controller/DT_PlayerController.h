...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FLMBDelegate);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRMBDelegate, bool, bHoldRotationYaw);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FDodgeDelegate);
